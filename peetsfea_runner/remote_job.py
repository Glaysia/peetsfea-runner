...
def _build_remote_job_script_content(*, emit_output_variables_csv: bool = True) -> str:
    lines = [
        ...
        "",
        "",
        "def reports_dir_for_design(workdir: Path, hfss: Hfss) -> Path:",
        "    design_key = report_slug(getattr(hfss, 'design_name', '') or 'design')",
        ...
        "    reports_dir = reports_dir_for_design(workdir, hfss)",
