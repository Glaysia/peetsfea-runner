...
def build_service_profile(*, repo_root: Path | None = None) -> ServiceProfile:
    ...
    prune_results_lane = LaneSpec(
        ...
        accounts=(
            AccountConfig(account_id="account_01", host_alias="gate1-harry261", max_jobs=8),
...
def _lane_pipeline_config(profile: ServiceProfile, lane: LaneSpec) -> PipelineConfig:
    ...
    return PipelineConfig(
        ...
        pull_workspace_user=profile.control_plane_return_user,
        pull_workspace_host=profile.control_plane_return_host,
        pull_workspace_path=str(profile.repo_root),
        ...
        slot_min_concurrency=1,
        slot_max_concurrency=lane.slots_per_job,
        ...
        worker_bundle_multiplier=4 if lane.lane_id == "prune_results" else 1,
