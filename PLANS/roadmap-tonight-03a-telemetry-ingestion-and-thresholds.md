...
| metric | action |
| --- | --- |
| `tmp_free_mb < 65536` | `03b` bad-node 후보 |
...
- `/tmp`, tunnel, idle slot, CSV gate가 서로 다른 action으로 연결된다.
