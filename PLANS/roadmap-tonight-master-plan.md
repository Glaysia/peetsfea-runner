...
| `04:00` | license-max 520 uniform slot scheduler 반영 | 유지 | 직전 green 값 유지 | CSV gate green 유지, license poll/control green 유지 | `LICENSE_POLL_FAILED`, `LICENSE_CEILING_REACHED`, canary red, restart red | `WORKER_LOOP_OK`, license poll ok, slot budget 증가 |
